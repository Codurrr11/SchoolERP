...
// Default: Only show students with a fee structure created and who have a balance
if (!$view_all) {
...
<div class="row align-items-center mb-4 g-3">
    <div class="col-sm-12">
        <h2 class="mb-1 font-heading fw-extrabold text-dark">Collect Fees</h2>
...
<div class="row mb-3 g-3">
    <div class="col-12">
        <form method="GET" action="index.php" id="feeFilterForm">
            <!-- Filter Toolbar -->
            <div class="fee-toolbar">
                <div class="fee-toolbar-left">
                    ...
                    <a href="index.php?view_all=1" class="fee-btn-primary" title="View All Students">
                        View All
                    </a>
                    <?php if ($view_all): ?>
                        <a href="index.php" class="fee-btn-secondary" title="Show Outstanding Balance Only">
            ...
            <!-- Pass view_all parameter if set -->
            <?php if ($view_all): ?>
                ...
                <div class="table-responsive">
                    <?php if (empty($students)): ?>
                        <div class="p-5 text-center">
                            ...
                            <h5 class="fw-semibold mt-3">No matching student records found</h5>
                            <p class="text-xs text-muted mb-0">Adjust your filter options or check the "View All" toggle to list all students.</p>
                        </div>
                    <?php else: ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.action-update-fee').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                fetch(`index.php?get_student_fees=1&id=${studentId}`)
                    .then(res => res.json())
                    .then(res => {
                        Swal.close();
                        if (res.success) {
...
<div class="modal fade" id="updateFeesModal" tabindex="-1" aria-labelledby="updateFeesModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <form action="index.php" method="POST" id="updateFeesForm">
                <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
...
<div class="modal fade" id="collectFeesModal" tabindex="-1" aria-labelledby="collectFeesModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <form action="index.php" method="POST" id="collectFeesForm" enctype="multipart/form-data">
                <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
...
<!-- Hidden Delete Form -->
<form action="index.php" method="POST" id="deleteFeesStructureForm" class="d-none">
    <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
